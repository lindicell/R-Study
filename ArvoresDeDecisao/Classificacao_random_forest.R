#
# ML: classificacao random forest
#
...
#
# Geracao do modelo preditivo -> classificacao random forest
#
#install.packages("randomForest")
library(randomForest)
set.seed(1) #gera uma matrix aleatória de dados igual para todos terem os mesmos atributos sorteados aleatoreamente para gerar as árvores

classificador <- randomForest(x = base_treinamento[-10], y = base_treinamento$income, ntree = 10)
classificador

# Avaliacao do modelo
previsoes <- predict(classificador, newdata = base_teste[-10])
previsoes
